...
export class MouseHandlers {
  ...
  _paneViews: UserAlertPricePaneView = undefined;
  ...
  attached(
    ...
    paneViews: UserAlertPricePaneView,
  ) {
    this._chart = chart;
    this._series = series;
    ...
    this._addMouseEventListener(container, 'mousedown', this._mouseClick);
  }
  ...
  _addMouseEventListener(
    ...
    eventType: 'mouseleave' | 'mousemove' | 'click' | 'mousedown',
